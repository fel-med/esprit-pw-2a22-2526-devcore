            ...
            return fetch(endpoint, {
                ...
                .catch((error) => {
                    return cre8pilotEnforceMinDelay({ status: 'error' }).then(() => {
                        appendMessage(messages, 'Cre8Pilot could not reach the assistant service right now.', 'assistant', 'error');
                        setComposerActivity(widget, '');
                        if (modeBadge) {
                            modeBadge.textContent = '';
                        }
                        ...
                        return {
                            ...
                            message: 'Cre8Pilot could not reach the assistant service right now.',
                        };
                    });
                });
        }
