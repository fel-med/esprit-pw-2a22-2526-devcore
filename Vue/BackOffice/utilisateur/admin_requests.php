...
$showCreateRequestCard = !empty($createReceiverOptions);
$showSentRequestsCard = !empty($sentRequests);
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="<?php echo $showCreateRequestCard ? 'col-lg-7' : 'col-12'; ?>">
                        <div class="card request-card h-100">
                            <div class="card-body">
