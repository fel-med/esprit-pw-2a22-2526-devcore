...
if (!function_exists('cre8AdminNotificationDateLabel')) {
    function cre8AdminNotificationDateLabel($value)
    {
        if (!$value) {
            return 'Just now';
        }
...
if (!function_exists('cre8RenderAdminNotificationItems')) {
    function cre8RenderAdminNotificationItems(array $items)
    {
        if (empty($items)) {
            ?>
        ...
        foreach ($items as $item):
            ...
            <article class="notification-item<?php echo $isUnread ? ' is-unread' : ''; ?>" data-notification-item data-notification-id="<?php echo (int) ($item['idNotificationAction'] ?? 0); ?>">
                ...
                <div class="notification-item-body">
                    ...
                    <time><?php echo htmlspecialchars(cre8AdminNotificationDateLabel($item['dateCreation'] ?? null)); ?></time>
...
?>
<div class="notification-widget notification-widget-admin" data-notification-widget>
    ...
    <section class="notification-panel" data-notification-panel hidden>
        ...
        <div class="notification-list" data-notification-list="all">
            <?php cre8RenderAdminNotificationItems($notificationItemsAll); ?>
        </div>
        <div class="notification-list" data-notification-list="unread" hidden>
            <?php cre8RenderAdminNotificationItems($notificationItemsUnread); ?>
        </div>
    </section>
</div>
<script>
